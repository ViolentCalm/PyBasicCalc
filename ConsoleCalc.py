...
# ConsoleCalc V2.1 ( Release Version ) [ nearly perfect ]
...
while True:
    ...
    # as the current RESULT for later, print the RESULT with newlines, and ask to continue or quit.

    # I do this for every possible function operation
    # because they are all nested within the function operation if statement.
    ...
    if fOp == str("div" or " div " or " div" or "div " or "divide" or " divide" or " divide " or "divide "):
        ...
        # if the question answer is 1, then continue ( loop back to beginning ) ,
        # and if it is 3, then break out of this loop? ( might be redundant )
    ...
    # This is the part where kWestion becomes redundant I believe,
    # because this if statement handled that for me without errors.
    # This if question == 2 is also what starts the second While True: loop
    # that handles calculations against previous numbers.
    # A slight alteration to the above calculation formula,
    # just including lastCalculation as the new global variable thingy.
    ...
    if question == str("2"):
        ...
        while True:
            ...
            if fOp == str("add" or " add" or "add " or " add " or
                          "addition" or " addition" or " addition " or "addition "):
                    RESULT2 = lastCalculation + sNumb
        
                    lastCalculation = RESULT2
        
            if fOp == str("subtract" or " subtract" or " subtract " or
                           "subtract " or "sub" or " sub" or "sub " or " sub "):

                RESULT2 = lastCalculation - sNumb
        
                lastCalculation = RESULT2

            if fOp == str("mult" or " mult" or "mult " or " mult " or "multiply" or
                          " multiply" or "multiply " or " multiply "):
            ...
            if fOp == str("div" or " div " or " div" or "div " or "divide" or " divide" or " divide " or "divide "):
                ...
                # Just for my own peace of mind, I create a custom BreakValue variable and define it as 1,
                # it only gets created at this moment.
    ...
    # Here I check the value of BreakValue
    # just to be sure we are still within the main loop and haven't left the solar system yet,
